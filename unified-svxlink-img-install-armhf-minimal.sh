...
apt-get install -y --force-yes --fix-missing sqlite3 libopus0 alsa-utils vorbis-tools sox libsox-fmt-mp3 librtlsdr0 \
	ntp libasound2 libspeex1 libgcrypt20 libpopt0 libopus0 libgsm1 tcl8.6 tk8.6 alsa-base bzip2 sudo flite \
	inetutils-syslogd uuid vim usbutils dialog logrotate cron gawk watchdog network-manager libsigc++-2.0-0c2a \
	libhamlib2 libhamlib2++c2 libasound2-plugin-equal i2c-tools python-configobj python-cheetah python-imaging \
	python-serial python-usb python-dev python-pip gpsd gpsd-clients
